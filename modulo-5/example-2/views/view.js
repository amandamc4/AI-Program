export class View {
    constructor() {
        this.elements = {
            ...
            aiDownloadButton: document.getElementById('ai-download-btn')
        };
    }
    ...
    onFormSubmit(callback) {
     ...
     onAIDownloadButtonClick(callback) {
        this.elements.aiDownloadButton.addEventListener('click', callback);
    }
}
