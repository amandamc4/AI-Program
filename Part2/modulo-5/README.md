...
- 👥 **Two User Roles**:
  - `amandacruz` (admin) - Can access file system tools
  - `arnoldgon` (member) - Cannot access file system tools
...
```bash
npm run chat -- --user arnoldgon --unsafe
```
