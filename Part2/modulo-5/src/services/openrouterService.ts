...
import { prompts, config, type ModelConfig } from '../config.ts';
...
export class OpenRouterService {
    ...
    // Uses another model to check if the prompt is safe or contains potential prompt injections
    // gives the guardrail instructions and the user input, and expects a safe/unsafe response
    // Langchain provides guardrail functionality but here we implement a custom one to demonstrate how it can be done manually and to have more control over the process and prompts
